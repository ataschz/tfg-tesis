...
const mockDispute = {
  ...
  description: "El contratista ha completado el milestone según lo acordado, pero el pago lleva más de 15 días de retraso sin justificación.",
  amount: 1500,
  currency: "USD",
      ...
      reviews: [
        {
          id: "rev_01",
          rating: 5,
          comment: "Excelente empresa para trabajar. Procesos claros y pagos puntuales.",
          author: "Ana García",
      ...
      reviews: [
        {
          id: "rev_02",
          rating: 5,
          comment: "Profesional excepcional, entrega puntual y excelente comunicación.",
