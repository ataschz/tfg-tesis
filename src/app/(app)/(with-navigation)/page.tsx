      ...
      <div className="flex-1 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-24 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-16">
            ...
            <section>
              <Card className="relative overflow-hidden max-w-[1200px] mx-auto">
                ...
                <div className="relative grid gap-6 p-8 md:grid-cols-2 md:p-12">
                  <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      Únete a miles de empresas que usan trato. para gestionar
                      su fuerza laboral global. Comienza tu prueba gratuita hoy.
                    </p>
