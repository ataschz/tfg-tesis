...
VALUES
    (
        gen_random_uuid(),
        '43511029-86ee-495d-9242-85e850fde3e6',
        'ata_desarrollador',
...
VALUES
    (
        gen_random_uuid(),
        'e8d6169f-9058-40f1-9321-2a075d0a3bd5',
...
VALUES
    (
        gen_random_uuid(),
        'e8d6169f-9058-40f1-9321-2a075d0a3bd5',
        -- Ata Contratante (cliente)
        '43511029-86ee-495d-9242-85e850fde3e6',
        -- Ata Contratista (contratista)
...
FROM
    contracts c
WHERE
    c.title = 'Desarrollo de Plataforma E-commerce'
...
FROM
    contracts c
WHERE
    c.title = 'Sistema de Gestión de Inventario'
LIMIT
    1;
...
SELECT
    ...
    (
        ...
        FROM
            user_profiles
        WHERE
            user_id = '89d0912b-5cbe-4786-9230-545e062d81c5'
    ),
    -- Ata Mediador
...
FROM
    contracts c
WHERE
    c.title = 'Chatbot con Inteligencia Artificial'
...
FROM
    disputes d
WHERE
    d.reason = 'Entregables no cumplen con especificaciones acordadas'
LIMIT
    1;
    ...
    (
        ...
        (
            ...
            FROM
                client_profiles
            WHERE
                user_profile_id = 'e8d6169f-9058-40f1-9321-2a075d0a3bd5'
        ),
        'business',
        'active',
...
VALUES
    ...
    (
        ...
        'Has recibido una nueva propuesta de contrato para "Portal Web para Proveedores" por $9,500',
        false,
        '/contracts',
        '2024-08-30 12:05:00+00'
    ),
    (
        gen_random_uuid(),
        '43511029-86ee-495d-9242-85e850fde3e6',
        'payment',
        'Pago Liberado',
        'Se ha liberado un pago de $3,605 por el proyecto de Sistema de Inventario',
        true,
        '/payments',
        '2024-08-15 10:20:00+00'
    ),
    (
        gen_random_uuid(),
        '43511029-86ee-495d-9242-85e850fde3e6',
        ...
        'Has recibido una reseña de 5 estrellas de Ata Contratante',
        true,
        '/reviews',
        '2024-04-20 10:35:00+00'
    ),
    (
        gen_random_uuid(),
        '43511029-86ee-495d-9242-85e850fde3e6',
        'dispute',
        'Disputa Abierta',
        'Se ha abierto una disputa para tu proyecto "Chatbot con Inteligencia Artificial"',
        false,
        '/disputes',
        '2024-07-10 11:25:00+00'
    ),
    ...
    (
        ...
        'Ata ha completado el milestone "Módulo de Productos" del Sistema de Inventario',
        true,
        '/contracts',
        '2024-08-12 17:05:00+00'
    ),
    (
        gen_random_uuid(),
        'e8d6169f-9058-40f1-9321-2a075d0a3bd5',
        'contract',
        'Contrato Completado',
        'Tu proyecto de Desarrollo de Plataforma E-commerce ha sido completado exitosamente!',
        true,
        '/contracts',
    ...
    (
        ...
        'contract',
        'Contrato Aceptado',
        'Ata ha aceptado tu propuesta para la Aplicación Móvil de Reservas',
        true,
        '/contracts',
        '2024-08-25 15:50:00+00'
    ),
    ...
    (
        ...
        'dispute',
        'Nueva Asignación de Disputa',
        'Se te ha asignado mediar una disputa para el proyecto "Chatbot con Inteligencia Artificial"',
        false,
        '/disputes',
        '2024-07-15 14:35:00+00'
    );
...
WHERE
    user_profile_id = '43511029-86ee-495d-9242-85e850fde3e6';

UPDATE
    client_profiles
SET
    average_rating = 5.0,
    total_contracts_created = 15
WHERE
    user_profile_id = 'e8d6169f-9058-40f1-9321-2a075d0a3bd5';
