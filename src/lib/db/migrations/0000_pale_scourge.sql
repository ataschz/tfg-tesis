CREATE TYPE "public"."account_transaction_status" AS ENUM('pending', 'completed', 'failed', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."account_transaction_type" AS ENUM('deposit', 'withdrawal', 'contract_payment', 'contract_refund');--> statement-breakpoint
CREATE TYPE "public"."availability" AS ENUM('full-time', 'part-time', 'unavailable');--> statement-breakpoint
CREATE TYPE "public"."contract_status" AS ENUM('sent', 'awaiting_deposit', 'pending_acceptance', 'accepted', 'rejected', 'in_progress', 'completed', 'cancelled', 'in_dispute');--> statement-breakpoint
...
ALTER TABLE "account_balances" ADD CONSTRAINT "account_balances_user_profile_id_user_profiles_id_fk" FOREIGN KEY ("user_profile_id") REFERENCES "public"."user_profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "account_transactions" ADD CONSTRAINT "account_transactions_user_profile_id_user_profiles_id_fk" FOREIGN KEY ("user_profile_id") REFERENCES "public"."user_profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "account_transactions" ADD CONSTRAINT "account_transactions_contract_id_contracts_id_fk" FOREIGN KEY ("contract_id") REFERENCES "public"."contracts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_account_balances_user_profile_id" ON "account_balances" USING btree ("user_profile_id");--> statement-breakpoint
CREATE INDEX "idx_account_transactions_user_profile_id" ON "account_transactions" USING btree ("user_profile_id");--> statement-breakpoint
CREATE INDEX "idx_account_transactions_type" ON "account_transactions" USING btree ("type");--> statement-breakpoint
CREATE INDEX "idx_account_transactions_status" ON "account_transactions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_account_transactions_contract_id" ON "account_transactions" USING btree ("contract_id");--> statement-breakpoint
