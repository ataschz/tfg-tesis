...
export function DisputeActions({
  ...
  const handleMetaMaskResolve = async (party: "contractor" | "client") => {
    ...
    const setLoading = isContractor
      ? setIsResolvingContractor
      : setIsResolvingClient;
    ...
    try {
      ...
      toast.loading(
        `Resolviendo disputa a favor del ${
          isContractor ? "freelancer" : "empresa"
        }...`
      );
      ...
      if (success) {
        ...
        console.log("🎯 DisputeActions - Winner selected:", {
          isContractor,
          contractorId: dispute.contract.contractor?.id,
          clientId: dispute.contract.client?.id,
            ...
            <Alert>
              ...
              <AlertDescription className="text-sm">
                ...
                {metaMask.isConnected && (
                  <>
                    <br />✅ Conectado: {metaMask.account?.slice(0, 6)}...
