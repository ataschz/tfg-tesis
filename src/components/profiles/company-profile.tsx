          ...
          <Card className="overflow-hidden">
            <div className="relative flex flex-col items-center p-6 pb-8 text-center md:flex-row md:text-left">
              <Avatar className="h-24 w-24 border-4 border-background">
                ...
                />
                <AvatarFallback>
                  {(company.clientProfile?.company || company.firstName)?.[0] ||
                    "C"}
                </AvatarFallback>
              </Avatar>
              <div className="mt-4 md:ml-6 md:mt-0">
                ...
                <p className="mt-1 text-muted-foreground">
                  {company.clientProfile?.industry ||
            ...
            <div className="mt-6 grid gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    href={company.clientProfile?.website || "#"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-medium text-primary hover:underline"
                  >
                    {company.clientProfile?.website || "No especificado"}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{company.userId}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Opiniones de contratistas que han trabajado con{" "}
            {company.clientProfile?.company ||
              `${company.firstName} ${company.lastName}`}
          </p>
        </div>
