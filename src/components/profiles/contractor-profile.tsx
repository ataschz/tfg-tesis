            ...
            <div className="relative flex flex-col items-center p-6 pb-8 text-center md:flex-row md:text-left">
              ...
              <div className="mt-4 md:ml-6 md:mt-0">
                ...
                <p className="mt-1 text-muted-foreground">
                  @{contractor.firstName?.toLowerCase()}
                  {contractor.lastName?.toLowerCase()}
                </p>
              </div>
            </div>
          </Card>
            ...
            <div className="mt-6 grid gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">USD 50/hora</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">UTC-3 (Buenos Aires)</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{contractor.userId}</p>
                </div>
              </div>
            </div>
